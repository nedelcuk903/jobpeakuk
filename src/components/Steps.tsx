...
const steps = [
    { id: '01', name: 'Выбор пакета', href: '#', status: 'complete' },
    { id: '02', name: 'Заполнение заявки', href: '#', status: 'current' },
    { id: '03', name: 'Предоставление списка документов', href: '#', status: 'upcoming' },
    { id: '04', name: 'Оплата', href: '#', status: 'upcoming' },
    { id: '05', name: 'Подача документов', href: '#', status: 'upcoming' },
    { id: '05', name: 'Виза готова!', href: '#', status: 'upcoming' },
]
